<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        <div class="flex flex-col p-4">
            ...
            <div class="mt-4">
                <p class="text-black">{{post.data.attributes.body}}</p>
            </div>
        </div>
        ...
        <div class="px-4 pt-2 flex justify-between text-gray-700 text-sm">
            ...
            <p>{{post.data.attributes.likes.like_count}}</p>
            </div>
    ...
    <div class="flex my-4 items-center" v-for="comment in post.data.attributes.comments.data" :key="comment">
           ...
           <div class="ml-4 flex-1">
               <div class="bg-gray-200 rounded-lg p-2 text-sm">
                    <a class="font-bold text-blue-700" :href="'/users/' + comment.data.attributes.commented_by.data.user_id" target="_blank">
